...
| Layer 2 Tunnel Protocol (L2TP)                                              | Underlying [[Virtual Private Network (VPN)\|VPN]] protocol that is unencrypted with no security. Should run IPSEC on top of                 | 1701      | UDP      |
| Point-to-Point Tunneling Protocol (PPTP)                                    | Underlying [[Virtual Private Network (VPN)\|VPN]] protocol that is encrypted                                                                | 1723      | TCP/UDP  |
